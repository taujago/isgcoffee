...
<head>
    ...
    <title>SISTEM INFORMASI EXECUTIVE DAN REPORTING</title>
    ...
    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url("vuexy"); ?>/app-assets/css/style.css">
    <!-- END: Custom CSS-->
    ...
    <script src="<?php echo base_url("vuexy") ?>/app-assets/vendors/js/charts/chart.min.js"></script>
    <script src="<?php echo base_url("vuexy") ?>/app-assets/vendors/js/charts/chartjs-plugin-labels.js"></script>
    ...
    <nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow">
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                ?>
                <li class="nav-item"> <span>Selamat Datang, </span> <strong><?php echo $userdata['username']; ?></strong>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="<?php echo base_url(); ?>"><span class="brand-logo">
